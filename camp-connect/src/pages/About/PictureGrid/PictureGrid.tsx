    ...
    return (
      <div className="pictures">
        ...
        >
          ...
          <span
            className={
              this.state.currentDisplay === "Adam Garrity"
                ? "bioShow"
                : "bioHide"
            }
          >
        ...
        <div
          className="smallGrid"
          onClick={() => this.setCurrentDisplay("Alex Morishige")}
        >
          <img className="headshot" src={headshotAlex}></img>
          <div className="gridName"> Alex Morishige </div>
          <span
            className={
              this.state.currentDisplay === "Alex Morishige"
                ? "bioShow"
                : "bioHide"
            }
          >
        ...
        <div
          className="smallGrid"
          onClick={() => this.setCurrentDisplay("Callie Teitelbaum")}
        >
          <img className="headshot" src={headshotCallie}></img>
          <div className="gridName"> Callie Teitelbaum </div>
          <span
            className={
              this.state.currentDisplay === "Callie Teitelbaum"
                ? "bioShow"
                : "bioHide"
            }
          >
            ...
            <p>
              ...
              philosophy. At Michigan, I work as a news staff reporter for the
              school newspaper, The Michigan Daily, and previously worked as a
              podcast content producer for The Daily Weekly. I serve on the
        ...
        <div
          className="smallGrid"
          onClick={() => this.setCurrentDisplay("David Bonilla")}
        >
          <img className="headshot" src={headshotDavidB} />
          <div className="gridName"> David Bonilla</div>
          <span
            className={
              this.state.currentDisplay === "David Bonilla"
                ? "bioShow"
                : "bioHide"
            }
          >
        ...
        <div
          className="smallGrid"
          onClick={() => this.setCurrentDisplay("David Lepelstat")}
        >
          <img className="headshot" src={headshotDavidD} />
          <div className="gridName"> David Lepelstat</div>
          <span
            className={
              this.state.currentDisplay === "David Lepelstat"
                ? "bioShow"
                : "bioHide"
            }
          >
        ...
        <div
          className="smallGrid"
          onClick={() => this.setCurrentDisplay("Dylan Marin")}
        >
          <img className="headshot" src={headshotDylan} />
          <div className="gridName"> Dylan Marin</div>
          <span
            className={
              this.state.currentDisplay === "Dylan Marin"
                ? "bioShow"
                : "bioHide"
            }
          >
            ...
            <p>
              ...
              undeclared. I've been studying Architecture and Engineering, in
              addition to a few other disciplines. I have a background in
              theatrical lighting design, and outside of class, I like
              longboarding, photography, and soccer.{" "}
            </p>
          </span>
        </div>
        ...
        <div
          className="smallGrid"
          onClick={() => this.setCurrentDisplay("Eli Glass")}
        >
        ...
        <div
          className="smallGrid"
          onClick={() => this.setCurrentDisplay("Gabby Asuncion")}
        >
          <img className="headshot" src={headshotGabby}></img>
          <div className="gridName"> Gabby Asuncion </div>
          <span
            className={
              this.state.currentDisplay === "Gabby Asuncion"
                ? "bioShow"
                : "bioHide"
            }
          >
        ...
        >
          ...
          >
            ...
            <p>
              ...
              Psychology. At school, I work as a teaching assistant for an
              introductory CS class as well as working in a child-psychology
              research lab. Outside of class, I enjoy cooking, pickup
              basketball, and theatrical lighting design.{" "}
            </p>
          </span>
        </div>
        ...
        <div
          className="smallGrid"
          onClick={() => this.setCurrentDisplay("Lea Jacobson")}
        >
          <img className="headshot" src={headshotLea}></img>
          <div className="gridName"> Lea Jacobson </div>
          <span
            className={
              this.state.currentDisplay === "Lea Jacobson"
                ? "bioShow"
                : "bioHide"
            }
          >
        ...
        >
          ...
          >
            ...
            <p>
              ...
              and Applied Mathematics. At school, I’m a member of the
              development team of Hack@Brown and a teaching assistant for a
              software engineering course. In my free time, I love hiking,
              trying my hand at a new mochi recipe, and working on random web
              projects. I will be working on the web portal and frontend
              experience of Camp Connect, and I’m excited to be on the team!
            </p>
          </span>
        </div>
