...
export default class About extends React.Component<AboutPageProps, AboutPageState> {
  ...
  render () {
    return ( 
      <div id="Background" style={{backgroundImage: `url(${blueBackground})`, backgroundRepeat: `repeat`}}>
        <img id="subwayLine" src={background}></img>
        <div id="About"> 
          <div id="AboutDescription">
            <h1 id="AboutTitle"> About Us </h1> 
            <div id="AboutText"> We are an energetic team of college students from some of the top universities across the country. 
